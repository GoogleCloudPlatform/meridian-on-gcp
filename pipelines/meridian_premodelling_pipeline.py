...
#compiler.Compiler().compile(meridian_data_analysis_component, "meridian_data_analysis_component.yaml")
...
def pipeline(epochs: int, model_dir: str, project: str = PROJECT_ID):
    ...
    meridian_data_analysis = (
        meridian_data_analysis_component(epochs=epochs, model_dir=model_dir)
